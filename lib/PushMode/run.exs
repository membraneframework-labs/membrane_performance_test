...
{:ok, pid} = Pipeline.start_link(%{
  n: 3,
  source: %PushMode.Elements.Source{initial_lower_bound: 0, initial_upper_bound: 400_000},
  filter: %PushMode.Elements.Filter{id: -1},
  sink: %PushMode.Elements.Sink{tick: 10_000, how_many_tries: 10, numerator_of_probing_factor: 1, denominator_of_probing_factor: 100}
})
Pipeline.play(pid)
